...
public class InMemoryDishRepository implements IDishRepository {
    ...
    @Override public DishDto save(DishDto dishDto)
    {
        store.put(dishDto.getId(), dishDto); return dishDto;
    }
    @Override public Optional<DishDto> findById(UUID id)
    {
        return Optional.ofNullable(store.get(id));
    }
    @Override public List<DishDto> findAll()
    {
