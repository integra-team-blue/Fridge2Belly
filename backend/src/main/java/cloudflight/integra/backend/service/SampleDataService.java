    ...
    private List<Dish> generateDishes(List<Ingredient> ingredients) {
        List<Dish> dishes = new ArrayList<>(Arrays.asList(
                                                          Dish.builder()
                                                                  ...
                                                                  .fat(8.0)
                                                                  .carbohydrates(35.0)
                                                                  .ingredients(new ArrayList<>(Arrays.asList(ingredients
                                                                          .get(0),
                                                                                                             ingredients
                                                                                                                     .get(1),
                                                                                                             ingredients
        ...
        List<Meal> meals = new ArrayList<>(Arrays.asList(
                                                         Meal.builder()
                                                                 ...
                                                                 .dateTime(LocalDateTime.now()
                                                                         .withHour(8)
                                                                         .withMinute(0))
                                                                 .dishes(new ArrayList<>(Arrays.asList(dishes.get(2),
                                                                                                       dishes.get(3)))) // Rice + Salad
                                                                 .build(),
                                                         ...
                                                         Meal.builder()
                                                                 ...
                                                                 .dateTime(LocalDateTime.now()
                                                                         .withHour(12)
                                                                         .withMinute(30))
                                                                 .dishes(new ArrayList<>(Arrays.asList(dishes.get(0),
                                                                                                       dishes.get(3)))) // Chicken Rice + Salad
                                                                 .build(),
                                                         ...
                                                         Meal.builder()
                                                                 ...
                                                                 .dateTime(LocalDateTime.now()
                                                                         .withHour(19)
                                                                         .withMinute(0))
                                                                 .dishes(new ArrayList<>(Arrays.asList(dishes.get(1),
                                                                                                       dishes.get(2)))) // Mediterranean Bowl + Rice
                                                                 .build(),
                                                         ...
                                                         Meal.builder()
                                                                 ...
                                                                 .dateTime(LocalDateTime.now()
                                                                         ...
                                                                         .withHour(18)
                                                                         .withMinute(45))
                                                                 .dishes(new ArrayList<>(Arrays.asList(dishes.get(4),
                                                                                                       dishes.get(2)))) // Herb Chicken + Rice
                                                                 .build()
        ));
