...
class IngredientDtoControllerTest {
    ...
    private IngredientDto createTestIngredient() {
    ...
    void getAllIngredients_ShouldReturn200WithList_WhenIngredientsExist() throws Exception {
        List<IngredientDto> ingredients = Arrays.asList(testIngredient);
    ...
    void updateIngredient_ShouldReturn200_WhenValidData() throws Exception {
        IngredientDto updatedIngredient = createTestIngredient();
        updatedIngredient.setName("Updated Tomato");
        updatedIngredient.setQuantity(3.0);

        when(ingredientsService.updateIngredient(eq(testId), any(IngredientDto.class)))
        ...
        verify(ingredientsService).updateIngredient(eq(testId), any(IngredientDto.class));
    }
